...
decoded_profile_legacy="$TEST_TMPDIR/decoded_profile_legacy.bin"
decoded_profile_robust="$TEST_TMPDIR/decoded_profile_robust.bin"
decoded_profile_override="$TEST_TMPDIR/decoded_profile_override.bin"
...
profile_legacy_err="$TEST_TMPDIR/profile_legacy.err"
profile_robust_err="$TEST_TMPDIR/profile_robust.err"
profile_override_err="$TEST_TMPDIR/profile_override.err"
...
grep -q '"rx_profile":"robust"' "$diag_err"
grep -q '"robust_defaults_enabled":true' "$diag_err"
grep -q '"legacy_baseline_available":true' "$diag_err"
grep -q '"same_bitrate_as_legacy":true' "$diag_err"
grep -q '"same_channel_as_legacy":true' "$diag_err"
grep -q '"estimated_clock_ppm":' "$diag_err"
grep -q '"clock_fit_error_rms_samples":' "$diag_err"
grep -q '"clock_fit_points":' "$diag_err"
grep -q '"adaptive_clock_tracking_enabled":true' "$diag_err"
grep -q '"adaptive_channel_templates_enabled":true' "$diag_err"
grep -q '"channel_template_known_symbols":' "$diag_err"
grep -q '"channel_template_energy":' "$diag_err"
grep -q '"channel_template_fallback_used":false' "$diag_err"
grep -q '"ideal_vs_adaptive_sync_score":' "$diag_err"
grep -q '"weighted_correlation_enabled":true' "$diag_err"
...
grep -q '"adaptive_llr_enabled":true' "$diag_err"
...
"$modem" --rx-profile=legacy --rx-diagnostics dec "$encoded" \
  "$decoded_profile_legacy" >/dev/null 2>"$profile_legacy_err"
cmp -s "$payload" "$decoded_profile_legacy"
grep -q '"rx_profile":"legacy"' "$profile_legacy_err"
grep -q '"robust_defaults_enabled":false' "$profile_legacy_err"
grep -q '"adaptive_llr_enabled":false' "$profile_legacy_err"
grep -q '"adaptive_clock_tracking_enabled":false' "$profile_legacy_err"
grep -q '"adaptive_channel_templates_enabled":false' "$profile_legacy_err"
grep -q '"weighted_correlation_enabled":false' "$profile_legacy_err"
"$modem" --robust-receiver --rx-diagnostics dec "$encoded" \
  "$decoded_profile_robust" >/dev/null 2>"$profile_robust_err"
cmp -s "$payload" "$decoded_profile_robust"
grep -q '"rx_profile":"robust"' "$profile_robust_err"
grep -q '"robust_defaults_enabled":true' "$profile_robust_err"
grep -q '"adaptive_llr_enabled":true' "$profile_robust_err"
grep -q '"adaptive_clock_tracking_enabled":true' "$profile_robust_err"
grep -q '"adaptive_channel_templates_enabled":true' "$profile_robust_err"
grep -q '"weighted_correlation_enabled":true' "$profile_robust_err"
"$modem" --rx-profile robust --no-weighted-correlation --no-adaptive-llr \
  --rx-diagnostics dec "$encoded" "$decoded_profile_override" \
  >/dev/null 2>"$profile_override_err"
cmp -s "$payload" "$decoded_profile_override"
grep -q '"rx_profile":"robust"' "$profile_override_err"
grep -q '"adaptive_llr_enabled":false' "$profile_override_err"
grep -q '"weighted_correlation_enabled":false' "$profile_override_err"
grep -q '"adaptive_clock_tracking_enabled":true' "$profile_override_err"
grep -q '"adaptive_channel_templates_enabled":true' "$profile_override_err"
